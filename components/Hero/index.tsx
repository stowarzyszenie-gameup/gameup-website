...
const Hero = () => {
  return (
    <div className="min-h-60 sm:min-h-96 xl:min-h-[50vh] bg-hero bg-cover bg-center w-full px-5 py-20 flex justify-center items-center">
      <div className=" max-w-screen-xl flex flex-col gap-4 items-center justify-around">
        ...
        <Button text="Dowiedz się więcej" href="/#about" />
      </div>
    </div>
  );
};
